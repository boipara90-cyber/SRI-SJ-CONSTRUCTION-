...
export const Logo: React.FC<LogoProps> = ({
  ...
  return (
    <div id="company-logo" className={`flex items-center gap-3 select-none ${className}`}>
      ...
      <div className={`relative flex items-center justify-center rounded-lg bg-white shadow-sm border border-zinc-700 shrink-0 overflow-hidden transition-all duration-200 hover:shadow-md ${iconSizes[size]}`}>
