    ...
    <section id="home" className="relative min-h-screen pt-28 sm:pt-32 pb-16 flex flex-col justify-between overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <img
          ...
          className="w-full h-full object-cover object-center opacity-25 filter blur-sm contrast-125 transition-opacity duration-1000 scale-105"
        />
        ...
        {/* Industrial Engineering Grid Accent in Orange */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#f9731612_1px,transparent_1px),linear-gradient(to_bottom,#f9731612_1px,transparent_1px)] bg-[size:36px_36px]" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-500/15 border border-orange-500/40 text-orange-400 text-xs sm:text-sm font-black tracking-wide shadow-sm">
                <span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" />
                ESTD. 2011 • HALDIA, WEST BENGAL
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-700 text-zinc-200 text-xs font-bold shadow-sm">
            ...
            <div className="flex items-center gap-3.5 p-3 sm:p-3.5 rounded-xl bg-[#0e0e12] border border-zinc-800 shadow-xl backdrop-blur-sm">
            ...
            <div className="space-y-2.5">
              <h1 className="text-3xl sm:text-5xl lg:text-[3.3rem] font-black text-white tracking-tight leading-[1.1] font-['Space_Grotesk']">
            ...
            <div className="pt-3 border-t border-zinc-800">
              <div className="text-[11px] font-black uppercase tracking-wider text-orange-400/90 mb-2">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs font-bold text-zinc-200">
                <span className="px-2.5 py-1 rounded-md bg-orange-500/15 border border-orange-500/30 text-orange-300 font-black shadow-xs">L&amp;T</span>
                <span className="px-2.5 py-1 rounded-md bg-orange-500/15 border border-orange-500/30 text-orange-300 font-black shadow-xs">TATA</span>
                <span className="px-2.5 py-1 rounded-md bg-orange-500/15 border border-orange-500/30 text-orange-300 font-black shadow-xs">JINDAL</span>
                <span className="px-2.5 py-1 rounded-md bg-orange-500/15 border border-orange-500/30 text-orange-300 font-black shadow-xs">SUNLIGHT</span>
                <span className="px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-700 text-zinc-300 shadow-xs">PGCIL</span>
                <span className="px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-700 text-zinc-300 shadow-xs">Ceratizit India</span>
                <span className="px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-700 text-zinc-300 shadow-xs">Ruchi Infra Haldia</span>
                <span className="px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-700 text-zinc-300 shadow-xs">Shreeji Propack</span>
                <span className="px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-700 text-zinc-300 shadow-xs">RG Baruah Nehru Stadium</span>
                <span className="px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-700 text-zinc-300 shadow-xs">Ganesh Complex Ranihati</span>
              </div>
            </div>

            {/* Registered Name Proper End of Point */}
            <div className="flex items-center gap-2 text-xs text-zinc-400 font-semibold pt-1">
          ...
          >
            <div className="rounded-3xl bg-[#0e0e12] border-2 border-zinc-800 shadow-2xl overflow-hidden relative group">
              
              {/* Top Live Feed Header Bar */}
              <div className="p-3.5 bg-black text-white flex items-center justify-between border-b border-zinc-800">
                <div className="flex items-center gap-2.5">
                  <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-orange-600 text-white text-[10px] font-black tracking-wider uppercase shadow-xs animate-pulse">
                    <Radio className="w-3 h-3 animate-spin" />
                    <span>LIVE SITE FEED</span>
                  </div>
                  <span className="text-xs font-bold text-zinc-300 truncate font-['Space_Grotesk']">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="p-1 rounded-md bg-zinc-800 hover:bg-zinc-700 text-orange-400 transition-colors cursor-pointer"
                    title={isPlaying ? "Pause rotation" : "Play rotation"}
                  >
                    {isPlaying ? <Pause className="w-3.5 h-3.5" /> : <Play className="w-3.5 h-3.5" />}
                  </button>

                  <div className="text-[11px] text-orange-400 font-mono font-bold px-1.5 py-0.5 rounded bg-zinc-900 border border-zinc-800">
              ...
              <div className="relative h-72 sm:h-80 w-full overflow-hidden bg-black">
                  ...
                  >
                    ...
                    <div className="absolute bottom-3 left-3 right-3 z-20 space-y-1.5">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded bg-orange-500 text-black shadow-md font-bold">
                          Verified Project
                        </span>
                        <span className="text-[10px] font-bold text-white px-2 py-0.5 rounded bg-black/80 backdrop-blur-xs border border-zinc-700">
                          {slide.location}
                        </span>
                      </div>
                      ...
                      <p className="text-xs text-orange-300 font-medium line-clamp-1 drop-shadow-xs">
                        {slide.projectNote}
                      </p>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="absolute left-2.5 top-1/2 -translate-y-1/2 z-30 p-2 rounded-full bg-black/80 hover:bg-orange-500 hover:text-black text-white transition-all shadow-md cursor-pointer border border-white/20 backdrop-blur-xs"
                >
                ...
                <button
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 z-30 p-2 rounded-full bg-black/80 hover:bg-orange-500 hover:text-black text-white transition-all shadow-md cursor-pointer border border-white/20 backdrop-blur-xs"
                >
                  <ChevronRight className="w-4 h-4" />
                </button>

                {/* Live Animated Progress Bar */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-zinc-800 z-30">
                  <div 
              ...
              <div className="p-4 bg-[#0e0e12] border-t border-zinc-800 space-y-3">
                ...
                <div className="pt-2 border-t border-zinc-800 flex flex-wrap items-center justify-between gap-2">
                  <div className="flex flex-wrap items-center gap-1.5">
                    {activeSlide.tags.map((tag, tIdx) => (
                      <span 
                        key={tIdx} 
                        className="text-[10px] font-bold px-2 py-0.5 rounded bg-zinc-900 text-zinc-300 border border-zinc-800"
                      >
                        {tag}
                      </span>
                    ))}
