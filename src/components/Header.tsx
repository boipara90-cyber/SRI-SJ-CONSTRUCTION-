    ...
    <header id="main-header" className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/40 text-emerald-300 font-bold text-[11px] cursor-pointer transition-colors"
      ...
      <nav className={`transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          {/* Logo */}
          <a href="#home" className="focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded-lg">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            ...
            <button
              ...
              id="header-quote-btn"
              className="relative inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-white font-black text-xs uppercase tracking-wider shadow-md shadow-emerald-600/25 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
            >
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button
              onClick={() => onOpenQuoteModal()}
              className="px-2.5 py-1.5 rounded-md bg-emerald-600 text-white text-[11px] font-bold shadow-sm"
          ...
          <div className="lg:hidden bg-white border-b border-slate-200 px-4 pt-4 pb-6 mt-3 space-y-2 shadow-lg animate-in fade-in slide-in-from-top-4 duration-200">
            <div className="grid grid-cols-2 gap-2 pb-3 border-b border-slate-200">
              {navLinks.map((link) => (
                <a
                  ...
                  className="px-3 py-2.5 text-sm font-semibold rounded-lg text-slate-700 hover:bg-emerald-500/10 hover:text-emerald-700 border border-transparent hover:border-emerald-500/20"
                >
                  {link.name}
                </a>
              ))}
            ...
            <div className="pt-2 space-y-2.5">
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-black text-sm flex items-center justify-center gap-2 shadow-md shadow-emerald-600/20"
              >
