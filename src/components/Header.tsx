        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span>Gmail Alerts: {ADMIN_NOTIFICATION_EMAIL}</span>
            </button>
            ...
            <a 
              ...
              className="hidden sm:flex items-center gap-1.5 text-slate-200 hover:text-amber-400 transition-colors font-medium"
            ...
            <div className="hidden md:inline-flex items-center gap-1 px-2 py-0.5 rounded bg-slate-800 border border-slate-700 text-slate-300 font-semibold text-[11px]">
              <span>Estd. 2013</span>
            </div>
          </div>
        </div>
      ...
      <nav className={`transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={() => onOpenQuoteModal()}
              className="px-3 py-1.5 rounded-md bg-amber-500 text-slate-950 text-xs font-bold shadow-sm"
